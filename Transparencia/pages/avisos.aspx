<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="avisos.aspx.cs" Inherits="Transparencia.pages.Avisos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="table-responsive" style="position: relative;">
        ...
        <ej:Dialog ID="commanddialog" ClientIDMode="Static" runat="server" Width="800" Title="Detalhes" ShowOnInit="false"
            EnableResize="False" Target="#gvAvisos" ShowFooter="True">
        </ej:Dialog>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    ...
    <script type="text/javascript">
        function onClick(args) {
            var grid = $("#gvAvisos").ejGrid("instance");
