<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ExpenseAnalysis.aspx.cs" Inherits="WebSampleBrowser.Dashboard.ExpenseAnalysis" %>
...
<%@ Register TagPrefix="ej" Namespace="Syncfusion.JavaScript.DataVisualization.Models" Assembly="Syncfusion.EJ, Version=15.1460.0.33, Culture=neutral, PublicKeyToken=3d67ed1f87d44c89" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Essential Studio for ASP.NET : Expense Analysis</title>
                            ...
                            <div class="col-xs-13 grid-container">
                                ...
                                <ej:Grid ID="ExpenseGrid" runat="server" EnableAltRow="true" AllowPaging="true" AllowSorting="true" IsResponsive="true" EnableResponsiveRow="false">
                                    ...
                                    <columns>
                                        ...
                                        <ej:Column Field="Amount" HeaderText="Amount" TextAlign="Right" Width="80" EditType="Numeric" Priority="4">
                                            <ValidationRule>
                                                <ej:KeyValue Key="required" Value="true" />
                                            </ValidationRule>
                                        </ej:Column>
        ...
        <script type="text/javascript">
            ...
            function UpdateGridChart(month) {
                var dataManger = ej.DataManager({
                    url: "//mvc.syncfusion.com/Services/api/expense?month=" + month,
                    offline: true,
